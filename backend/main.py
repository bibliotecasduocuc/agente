...
async def _registrar_metrica(consulta_texto, modelo, conversation_id=""):
...
async def chat(req: ChatRequest, request: Request):
    ...
    if faq is not None:
        ...
        asyncio.create_task(_registrar_metrica(_consulta_texto, "faq", _conv_id))
    ...
    asyncio.create_task(_registrar_metrica(_consulta_texto,
                                           "haiku" if "haiku" in modelo else "sonnet", _conv_id))
